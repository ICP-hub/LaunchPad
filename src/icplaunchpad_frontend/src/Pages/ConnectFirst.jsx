...
import ConnectWallets from '../components/Modals/ConnectWallets.jsx' 
...
const ConnectFirst = () => {
  ...
  return (
    <div className="flex justify-center items-center  bg-black text-white">
      <div className="w-full max-w-[1070px] py-8  rounded-2xl">
        ...
        <div className="bg-[#222222] p-4 rounded-2xl ">
          ...
          <div className="w-[90%] mx-auto mt-5 flex pl-4  flex-row  items-center justify-evenly mb-[5%]">
          ...
          <button onClick={()=> openModal() }
           type='submit' className='border-1  font-posterama  bg-gradient-to-r from-[#F3B3A7] to-[#CACCF5] 
