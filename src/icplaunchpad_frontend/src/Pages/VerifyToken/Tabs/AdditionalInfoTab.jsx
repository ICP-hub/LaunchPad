...
const AdditionalInfoTab = () => {
  return (
    <div className="bg-[#222222] p-3 xxs1:p-8  rounded-2xl  lg:h-[1050px] mx-8  xxs1:mb-11  mb-[120px] sm5:mb-6 md:mb-4   lg:mb-0  h-[1350px]  xxs1:h-[1000px]">
      ...
      <div className="flex    justify-center items-center  ">
        <button className="border-1  hidden xxs1:block  bg-gradient-to-r from-[#F3B3A7] to-[#CACCF5] 
          text-black  relative w-[120px] xxs1:w-[250px] md:w-[360px] h-[35px]
