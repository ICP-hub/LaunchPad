...
const AdditionalInfoTab = ({
  ...
  const updateLink = (index, field, value) => {
    const updatedSocialLinks = [...presaleDetails.social_links];
    ...
    <div className="bg-[#222222] p-3 rounded-2xl mx-3 mb-[80px] dxs:mb-[140px] xxs1:mb-[90px] sm2:mb-[70px] md:mb-[10px]">
      ...
      <div className="w-full mb-4">
        ...
        <input
          type="text"
          {...register("website")}
          className={`w-full p-2 bg-[#333333] text-white rounded-md ${errors.website ? "border-red-500" : "border-white"} border-b-2`}
        />
      ...
      <div className="mb-4">
        ...
        {presaleDetails.social_links.map((link, index) => (
          <div key={index} className="flex gap-2 items-center mb-2">
            ...
            <input
              type="url"
              className={`w-full p-2 bg-[#333333] text-white rounded-md${errors.link ? "border-red-500" : "border-white"}  border-b-2`}
              placeholder="Enter URL"
              value={link.url}
              onChange={(e) => updateLink(index, "url", e.target.value)}
            />
            <button onClick={() => removeLink(index)} className="ml-2 text-red-500">
              <FaTrash />
            </button>
          </div>
        ))}
      ...
      <div className="flex flex-col mb-24">
        ...
        <textarea
          ...
          className={`w-full p-2 bg-[#333333] text-white rounded-md h-32 ${errors.description ? "border-red-500" : "border-white"} border-b-2`}
        ></textarea>
