    ...
    <div className="container   mx-auto sm1:px-[9%] py-8 font-posterama text-center">
      ...
      <div className="flex items-center   justify-center  h-[270px] md:h-[200px] gap-4 lg:gap-11 ">
        ...
        <div className="bg-[#333333] hidden sm1:block h-[220px] w-[400px]  py-9 rounded-lg ">
          ...
          <p className="text-center uppercase text-[8px] md:text-[10px] md1:text-[11px] dxl:text-[15px] px-8 ">Gain access to a worldwide network of committed supporters within an open and decentralized environment.</p>
        </div>
        ...
        <div className="bg-[#333333]   h-[220px] w-[400px]  py-9 rounded-lg ">
          ...
          <p className="text-center uppercase  text-[15px] sm1:text-[7px] md:text-[10px] md1:text-[11px] dxl:text-[15px] px-4 sm:px-10">Cultivate and foster your most devoted advocates from the outset. They are your steadfast allies!</p>
        </div>
        ...
        <div className="bg-[#333333] hidden sm1:block  h-[220px] w-[400px]   py-9 rounded-lg">
          ...
          <p className="text-center text-[7px] md:text-[12px] dxl:text-[15px] uppercase px-6">Seize complete command of your fundraising efforts and leverage them to their fullest potential.</p>
        </div>
      </div>
    </div>
  );
